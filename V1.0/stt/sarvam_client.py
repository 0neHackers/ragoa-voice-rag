...
def load_audio_file(path: str | Path) -> Audio:
    """Read any soundfile-supported audio into 16kHz mono 16-bit PCM.

    Resampling is done here rather than server-side because Sarvam's models expect
    16kHz; handing them 44.1kHz audio degrades accuracy on Indic phonemes.
    """
    import numpy as np
