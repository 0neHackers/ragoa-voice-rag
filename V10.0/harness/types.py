...
class TranslationInfo(BaseModel):
    """Set when the user opted into translating an English question into Hindi.

    Both strings are kept so the UI can show what was asked and what was actually
    searched for — a translated query is never presented as though the user typed it.
    """
